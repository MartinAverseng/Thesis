...
struct cElementNodes {
	int * list;
};

struct cElementEdges {
	int * list;
};
...
struct triangulateio {
  ...
  /* conectivities */
  struct cElementNodes cTN;
  struct cElementEdges cTE;
  struct cEdgeNodes    cEN;
  struct cEdgeElements cET;
  struct cNodeEdges    cNE;
  struct cNodeElements cNT;
};
