...
\toDo{Parler d'abord des estimations d'erreurs. Ensuite expliquer à quoi servent les PPDO et parler de la nouveauté de cette classe d'opérateurs. Parler de la possibilité de calculer avec des logiciels. Dire qu'on ne rappelle pas le contexte applicatif qui est bien détaillé dans la partie I.}
...
\end{cases}\]
Those identities are fundamental in our analysis. A proof can be found in \cite{} \toDo{reprendre ref}. We deduce easily
\begin{Lem}
...
\toDo{Donner une raison pour laquelle on fait les pseudo-diffs. On veut analyser les préconditionneurs. On veut un calcul symbolique pour reproduire la preuve standard en termes d'op pseudo-diffs. }
...
\begin{proof}
	...
	\end{split}\]
	\toDo{très moche, non ? ça prend beaucoup de ligne si on fait une par une.}\\
